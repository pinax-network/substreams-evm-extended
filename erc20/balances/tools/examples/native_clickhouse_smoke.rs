...
mod native {
    ...
    #[derive(Parser)]
    struct Args {
        #[arg(long, default_value = "spkg/erc20-balances-v0.1.0.spkg")]
        package: PathBuf,
        #[arg(long, default_value = "erc20/balances/tests/fixtures/bridge450/layouts.json")]
        layouts: PathBuf,
        #[arg(long, default_value = "erc20/balances/tests/fixtures/bridge450/cases.json")]
        expected: PathBuf,
