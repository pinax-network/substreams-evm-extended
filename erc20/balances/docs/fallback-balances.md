...
cargo run --locked -p erc20-balances-tools -- audit-rpc \
  ...
  --layouts erc20/balances/tests/fixtures/bsc-fallback-layouts.json \
  --output erc20/balances/out/my-fallback-audit

cargo run --locked -p erc20-balances-tools -- capture-blocks \
  --start 122288160 --blocks 128 \
  --output erc20/balances/out/my-fallback-holder-blocks

cargo run --locked -p erc20-balances-tools -- holder-coverage \
  --ranking erc20/balances/out/top50-1024/report.json \
  --block-dir erc20/balances/out/my-fallback-holder-blocks \
  --layouts erc20/balances/tests/fixtures/bsc-fallback-layouts.json \
  --output erc20/balances/out/my-fallback-holder-coverage
```
