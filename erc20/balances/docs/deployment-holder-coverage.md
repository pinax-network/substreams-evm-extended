...
cargo run --locked -p erc20-balances-tools -- audit-rpc \
  --layouts erc20/balances/tests/fixtures/bsc-deployment-layouts.json \
  --start 122288330 --blocks 256 --workers 2 \
  --output erc20/balances/out/my-deployment-audit

cargo run --locked -p erc20-balances-tools -- capture-blocks \
  --start 122288330 --blocks 128 \
  --output erc20/balances/out/my-deployment-blocks

cargo run --locked -p erc20-balances-tools -- holder-coverage \
  --ranking erc20/balances/out/top50-1024/report.json \
  --block-dir erc20/balances/out/my-deployment-blocks \
  --layouts erc20/balances/tests/fixtures/bsc-deployment-layouts.json \
  --output erc20/balances/out/my-deployment-holders
```
